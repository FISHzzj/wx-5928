...
module.exports = {
  ...
  getUrl: function(n, o, i) {
    ...
    return o && ("object" == (void 0 === o ? "undefined" : t(o)) ? a += "&" + e.param(o) : "string" == typeof o && (a += "&" + o)), a
  },
  ...
  json: function(t, n, o, i, a, c) {
    ...
    c || delete l.header.Cookie,
     a && (l.data = e.param(n)),
      ...
      i && d.hideLoading(), 
      "request:ok" == t.errMsg && "function" == typeof o && (r.setCache("authkey", t.data.authkey || ""), 
      o(t.data))
    }), wx.request(l)
  ...
  onShareAppMessage: function(t) {
    var e = getApp(),
      ...
      c = n.shopname || "",
      r = n.description || "";
    return o.title && (c = o.title), o.desc && (r = o.desc), i && (a = i.id), t = t || "/pages/index/index", t = -1 != t.indexOf("?") ? t + "&" : t + "?", {
      title: c,
      desc: r,
      path: t + "mid=" + a
    }
